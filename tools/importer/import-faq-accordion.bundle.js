  ...
  function parse(element, { document: document2 }) {
    ...
    items.forEach((item) => {
      ...
      source.querySelectorAll("p, h1, h2, h3, h4, h5, h6, ul, ol, img, picture, a").forEach((node) => {
        if (node.matches("a, img, picture") && node.closest("p, ul, ol, h1, h2, h3, h4, h5, h6")) {
          return;
        }
        if (node.matches("p, h1, h2, h3, h4, h5, h6") && !node.textContent.trim() && !node.querySelector("img, picture, a")) {
          return;
        }
        bodyCell.push(node);
      });
    ...
    sections: [
      {
        id: "s1",
        name: "FAQ Content",
        selector: [".accordion.panelcontainer", "main .cmp-container"],
        style: null,
        blocks: ["accordion-faq"],
        defaultContent: ["main h1", ".cmp-image", ".cmp-text"]
      },
      {
        id: "s2",
        name: "Need more help",
        selector: [".title.cmp-title--right", "main main:last-of-type"],
        style: null,
        blocks: [],
        defaultContent: ["h3", ".cmp-text"]
      }
    ]
  };
  var transformers = [
